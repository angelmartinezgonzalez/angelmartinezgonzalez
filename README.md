...
- Creación de pipelines de ML con **PySpark en Azure Databricks** y despliegue en GCP/AWS.  
- Dashboards en **Power BI** para monitoreo de KPIs financieros.  
- Liderazgo de equipos técnicos de hasta **20 personas**.  

**Seguros**  
- Desarrollo de ETLs en **Python y Spark** para análisis de pólizas de Vida, Autos y Gastos Médicos.  
